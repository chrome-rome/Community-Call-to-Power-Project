...
--**Links Between Industrial and Nuclear**

SELECT									'TECH_TRENCH_WARFARE',					'TECH_MILITARY_SCIENCE'			UNION ALL
SELECT									'TECH_TRENCH_WARFARE',					'TECH_BOMBARDMENT'				UNION ALL
SELECT									'TECH_TRENCH_WARFARE',					'TECH_REPLACEABLE_PARTS'		UNION ALL
SELECT									'TECH_TRENCH_WARFARE',					'TECH_ARCHAEOLOGY'				UNION ALL
SELECT									'TECH_FLIGHT',							'TECH_ELECTRICITY'				UNION ALL
SELECT									'TECH_FLIGHT',							'TECH_REFINING'					UNION ALL
SELECT									'TECH_FLIGHT',							'TECH_INDUSTRIAL_PROCESSES'		UNION ALL
SELECT									'TECH_FLIGHT',							'TECH_SHELLS'					UNION ALL
SELECT									'TECH_TORPEDOES',						'TECH_NAVAL_ARMOR'				UNION ALL
SELECT									'TECH_TORPEDOES',						'TECH_BOMBARDMENT'				UNION ALL
SELECT									'TECH_TORPEDOES',						'TECH_RAILROAD'					UNION ALL
SELECT									'TECH_TORPEDOES',						'TECH_INDUSTRIALIZATION'		UNION ALL


SELECT									'TECH_GENETICS',						'TECH_PHARMACEUTICALS'			UNION ALL
SELECT									'TECH_GENETICS',						'TECH_REFRIGERATION'			UNION ALL
SELECT									'TECH_GENETICS',						'TECH_MILITARY_SCIENCE'			UNION ALL
SELECT									'TECH_GENETICS',						'TECH_CORPORATIONS'				UNION ALL
SELECT									'TECH_PLASTIC',							'TECH_SCIENTIFIC_THEORY'		UNION ALL
SELECT									'TECH_PLASTIC',							'TECH_INDUSTRIAL_PROCESSES'		UNION ALL
SELECT									'TECH_PLASTIC',							'TECH_DYNAMITE'					UNION ALL


SELECT									'TECH_RADIO',							'TECH_ELECTRICITY'				UNION ALL
SELECT									'TECH_RADIO',							'TECH_CORPORATIONS'				UNION ALL
SELECT									'TECH_RADIO',							'TECH_MILITARY_TRADITION'		UNION ALL
SELECT									'TECH_BIOTECH_INDUSTRY',				'TECH_INDUSTRIAL_PROCESSES'		UNION ALL
SELECT									'TECH_BIOTECH_INDUSTRY',				'TECH_PHARMACEUTICALS'			UNION ALL
SELECT									'TECH_BIOTECH_INDUSTRY',				'TECH_SCIENTIFIC_THEORY'		UNION ALL
SELECT									'TECH_BIOTECH_INDUSTRY',				'TECH_STEAM_POWER';

-- Populate the table, Nuclear Techs 
INSERT INTO Technology_PrereqTechs		(TechType,								PrereqTech)
--Revolutionary Warfare
SELECT									'TECH_BALLISTICS',						'TECH_TRENCH_WARFARE'			UNION ALL
SELECT									'TECH_BALLISTICS',						'TECH_FLIGHT'					UNION ALL
SELECT									'TECH_BLITZKRIEG',						'TECH_TRENCH_WARFARE'			UNION ALL
SELECT									'TECH_BLITZKRIEG',						'TECH_TORPEDOES'				UNION ALL
SELECT									'TECH_BIG_GUNS_DOCTRINE',				'TECH_TORPEDOES'				UNION ALL
SELECT									'TECH_COMBUSTION',						'TECH_BIG_GUNS_DOCTRINE'		UNION ALL
SELECT									'TECH_COMBUSTION',						'TECH_BALLISTICS'				UNION ALL
SELECT									'TECH_COMBINED_ARMS',					'TECH_BALLISTICS'				UNION ALL
SELECT									'TECH_TRACKED_VEHICLES',				'TECH_TORPEDOES'				UNION ALL

--Molecule
SELECT									'TECH_ELECTRONICS',						'TECH_PLASTIC'					UNION ALL
SELECT									'TECH_PENICILIN',						'TECH_GENETICS'					UNION ALL
SELECT									'TECH_VACCINES',						'TECH_GENETICS'					UNION ALL
SELECT									'TECH_ATOMIC_THEORY',					'TECH_ELECTRONICS'				UNION ALL
SELECT									'TECH_ATOMIC_THEORY',					'TECH_VACCINES'					UNION ALL

--Environment
SELECT									'TECH_CONSERVATIONISM',					'TECH_BIOTECH_INDUSTRY'			UNION ALL
SELECT									'TECH_SOLAR_POWER',						'TECH_CONSERVATIONISM'			UNION ALL
SELECT									'TECH_ECOLOGY',							'TECH_CONSERVATIONISM'			UNION ALL
SELECT									'TECH_GLOBALIZATION',					'TECH_RADIO'					UNION ALL
SELECT									'TECH_GLOBALIZATION',					'TECH_ECOLOGY'					UNION ALL

--**Links Between Nuclear and Modern**

SELECT									'TECH_STEALTH',							'TECH_RADIO'					UNION ALL
...
SELECT									'TECH_TELECOM',							'TECH_GLOBALIZATION';
...
SELECT									'TECH_RADAR',							'TECH_ADVANCED_FLIGHT'			UNION ALL
