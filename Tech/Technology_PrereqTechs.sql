...
SELECT									'TECH_VACCINES',						'TECH_MILITARY_SCIENCE'			UNION ALL
...
SELECT									'TECH_COMBUSTION',						'TECH_DYNAMITE'					UNION ALL
...
SELECT									'TECH_ECOLOGY',							'TECH_PHARMACEUTICALS'			UNION ALL
SELECT									'TECH_ECOLOGY',							'TECH_SCIENTIFIC_THEORY';		
...
SELECT									'TECH_TRACKED_VEHICLES',				'TECH_BALLISTICS'				UNION ALL
SELECT									'TECH_BLITZKRIEG',						'TECH_BALLISTICS'				UNION ALL

--Molecule
SELECT									'TECH_GENETICS',						'TECH_VACCINES'					UNION ALL
SELECT									'TECH_PENICILIN',						'TECH_GENETICS'					UNION ALL
SELECT									'TECH_PENICILIN',						'TECH_PLASTIC'					UNION ALL
SELECT									'TECH_ATOMIC_THEORY',					'TECH_PLASTIC'					UNION ALL
SELECT									'TECH_ATOMIC_THEORY',					'TECH_COMBUSTION'				UNION ALL
SELECT									'TECH_NUCLEAR_FISSION',					'TECH_ATOMIC_THEORY'			UNION ALL

--Environment
SELECT									'TECH_ELECTRONICS',						'TECH_RADIO'					UNION ALL
SELECT									'TECH_SOLAR_POWER',						'TECH_ECOLOGY'					UNION ALL
SELECT									'TECH_GLOBALIZATION',					'TECH_ELECTRONICS'				UNION ALL
SELECT									'TECH_GLOBALIZATION',					'TECH_SOLAR_POWER'				UNION ALL
SELECT									'TECH_BIOTECH_INDUSTRY',				'TECH_SOLAR_POWER'				UNION ALL
